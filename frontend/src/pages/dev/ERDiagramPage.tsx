  ...
  return (
    <div className="space-y-4 h-[calc(100vh-8rem)] flex flex-col">
      <div>
        ...
        <p className="text-slate-500">So do quan he 25 bang backend Luan - keo/zoom de xem.</p>
      </div>
      ...
      <Card>
        <CardHeader><CardTitle className="text-sm">Chu giai mau</CardTitle></CardHeader>
        <CardContent className="flex flex-wrap gap-3 text-xs">
          <Legend color="#6366f1" label="Core identity (ttcn)" />
          <Legend color="#8b5cf6" label="Nguoi dung (SV/CB)" />
          <Legend color="#10b981" label="Cau truc (Khoa/CN)" />
          <Legend color="#f59e0b" label="Khung dao tao" />
          <Legend color="#d946ef" label="Hoc phan" />
          <Legend color="#ec4899" label="Diem" />
          <Legend color="#0ea5e9" label="Lop" />
          <Legend color="#f97316" label="Hoat dong" />
          <Legend color="#94a3b8" label="Bang lien ket" />
        </CardContent>
      </Card>
    </div>
  );
