...
const PRESETS = [
  ...
  { label: 'POST /auth/login (admin)', method: 'POST' as Method, path: '/api/auth/login', body: JSON.stringify({ username: 'ADMIN01', password: 'admin123', role: 'admin' }, null, 2) },
  { label: 'GET /auth/me', method: 'GET' as Method, path: '/api/auth/me', body: '' },
  { label: 'GET /admin/tables/sinhVien', method: 'GET' as Method, path: '/api/admin/tables/sinhVien?page=1&pageSize=10', body: '' },
];
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-slate-500">Call Luan backend endpoints directly.</p>
      </div>
        ...
        <CardContent className="p-4 space-y-3">
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="icon" onClick={() => { setToken(''); toast.info('Token cleared'); }}>
